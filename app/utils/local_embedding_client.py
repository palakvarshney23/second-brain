...
class LocalEmbeddingClient:
    ...
    async def get_embedding(self, text: str) -> list[float] | None:
        ...
        try:
            ...
            logger.exception("Failed to get text embedding")
            return None
    ...
    async def get_image_embedding(self, image_bytes: bytes) -> list[float] | None:
        ...
        try:
            ...
            logger.exception("Failed to get image embedding")
            return None
    ...
    async def analyze_content(
        ...
        try:
            ...
            logger.exception("Failed to analyze content")
            return None
...
- Reasoning: [brief explanation]"""
        ...
        try:
            ...
            logger.exception("Failed to classify content")
            return None
